% HYUletter_example.tex - an example latex file to illustrate HYUletter.cls
%
...
% Modified by Huang Weiran (huangweiran1998@outlook.com) to fit the need of HYU students.

\usepackage{verbatim}
\documentclass[12pt]{HYUletter}
\usepackage{fontspec} 
\usepackage{tikz} 
\usepackage{xcolor}
...
College of Computing,\\ Hanyang University ERICA campus
}} 
%%%%%%%%%%%%  Additional Contact Information %%%%%%%%%%%
%
% Set your preferred primary contact address here.
\def\Address{55 Hanyangdeahak-ro, Sangnok-gu, Ansan-si, Gyeonggi-do,  
} 
%
\def\CityZip{15588, Korea} 
%
% Set your HYU e-mail here
\def\Email{\textbf{\color{fudanblue}E-mail}: xxx@hanyang.ac.kr}
%
% Set your preferred contact number here
\def\TEL{\textbf{\color{fudanblue}Phone}: +82 xxx}
%
...
\def\school{\small{
  Hanyang University $\cdot$
     ~College of Computing $\cdot$
     ~Ansan-si $\cdot$
     ~Gyeonggi-do, Korea} } 
